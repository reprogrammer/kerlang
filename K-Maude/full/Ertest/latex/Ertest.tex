...
\bigskip \par \textsc{K equations and rules:}\setlength{\parindent}{2em}
  ...
  \kequation{}{\mixfixPiece{\kprefix{green}{k}{\reduce{\mixfixPiece{\variable{
    ...
    \ensuremath{\kdot}}}}}}}}
  \kequation{}{\mixfixPiece{\kprefix{green}{k}{\reduce{\mixfixPiece{\variable{
    N}\mixfixSep{}(\mixfixSep{}\variable{P}\mixfixSep{})=> \mixfixSep{
  ...
  \kcrule{}{\mixfixPiece{\kprefix{green}{k}{\reduce{\mixfixPiece{\mixfixPiece{
    \prefixOp{check-msg}(\mixfixSep{}\mixfixPiece{\variable{P}\mixfixSep{}~>
  ...
  \kcrule{}{\mixfixPiece{\kprefix{green}{k}{\reduce{\mixfixPiece{\prefixOp{
    check-msg}(\mixfixSep{}\mixfixPiece{\mixfixPiece{\variable{P}\mixfixSep{}~>
  ...
  \kcrule{}{\mixfixPiece{\kprefix{green}{k}{\reduce{\mixfixPiece{\prefixOp{
    check-msg}(\mixfixSep{}\mixfixPiece{\variable{P}\mixfixSep{}~> \mixfixSep{
  ...
  \mequation{}{\mixfixPiece{\variable{N}\mixfixSep{}()=> \mixfixSep{}\variable{
    ...
    \mixfixSep{}\constant{[]}\mixfixSep{}}}\mixfixSep{})=> \mixfixSep{
    }\variable{T}}}
