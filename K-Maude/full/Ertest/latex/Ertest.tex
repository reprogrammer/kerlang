...
\par \textsc{syntactic constructs:}\setlength{\parindent}{2em}
  ...
  \syntax{\nonTerminal{\sort{CaseClauses}}}{}{}
  \syntaxCont{\nonTerminal{\sort{CaseClauses}}}{\nonTerminal{\sort{
    CaseClauses}}\mixfixSep{}; \mixfixSep{}\nonTerminal{\sort{CaseClauses}}}{}
  \syntaxCont{\nonTerminal{\sort{CaseClauses}}}{\nonTerminal{\sort{
    Pattern}}\mixfixSep{}:> \mixfixSep{}\nonTerminal{\sort{Exp}}}{}
  \syntax{\nonTerminal{\sort{Cases}}}{}{}
  \syntaxCont{\nonTerminal{\sort{Cases}}}{\nonTerminal{\sort{Cases}}\mixfixSep{
    }; \mixfixSep{}\nonTerminal{\sort{Cases}}}{}
  \syntaxCont{\nonTerminal{\sort{Cases}}}{AnyVar(\mixfixSep{}\nonTerminal{
    \sort{Pattern}}\mixfixSep{},\mixfixSep{}\nonTerminal{\sort{
    Exps}}\mixfixSep{})}{}
  ...
  \syntaxCont{\nonTerminal{\sort{Exp}}}{case \mixfixSep{}\nonTerminal{\sort{
    Pattern}}\mixfixSep{}of \mixfixSep{}\nonTerminal{\sort{
    CaseClauses}}\mixfixSep{}end}{strict(1)}
  ...
  \syntaxCont{\nonTerminal{\sort{FunCases}}}{AnyVar(\mixfixSep{}\nonTerminal{
    \sort{\#Name}}\mixfixSep{},\mixfixSep{}\nonTerminal{\sort{
    Pattern}}\mixfixSep{},\mixfixSep{}\nonTerminal{\sort{Exps}}\mixfixSep{})}{}
  \syntax{\nonTerminal{\sort{Mod}}}{}{}
...
\bigskip \par \textsc{K equations and rules:}\setlength{\parindent}{2em}
  ...
  \kequation{}{\mixfixPiece{\kprefix{green}{k}{\reduce{\mixfixPiece{\prefixOp{
    AnyVar}(\mixfixSep{}\variable{N}\mixfixSep{},\mixfixSep{}\variable{
    P}\mixfixSep{},\mixfixSep{}\variable{E}\mixfixSep{})}}{\constant{
    \ensuremath{\kdot}}}}\mixfixSep{}\mixfixPiece{\kall{white}{current}{
    \variable{M}}\mixfixSep{}\mixfixPiece{\kall{white}{name}{\variable{
    M}}\mixfixSep{}\kall{white}{funs}{\reduce{\variable{G}}{\mixfixPiece{
    \variable{G}\mixfixSep{}[\mixfixSep{}\variable{N}\mixfixSep{}\ensuremath{
    \leftarrow}\mixfixSep{}\mixfixPiece{< \mixfixSep{}\variable{P}\mixfixSep{},
    \mixfixSep{}\variable{E}\mixfixSep{}>}\mixfixSep{}]}}}}}}}
  \kequation{}{\mixfixPiece{\kprefix{green}{k}{\reduce{\mixfixPiece{\prefixOp{
  ...
  \kcequation{}{\mixfixPiece{\kprefix{green}{k}{\reduce{\mixfixPiece{case
    ...
    P\ensuremath{\nothing_{1}}}\mixfixSep{}:> \mixfixSep{}\variable{
  ...
  \kcrule{}{\mixfixPiece{\kprefix{green}{k}{\reduce{\mixfixPiece{receive
    \mixfixSep{}\mixfixPiece{\prefixOp{AnyVar}(\mixfixSep{}\variable{
    P}\mixfixSep{},\mixfixSep{}\variable{E}\mixfixSep{})}\mixfixSep{}end}}{
  ...
  \kcrule{}{\mixfixPiece{\kprefix{green}{k}{\mixfixPiece{receive \mixfixSep{
    }\mixfixPiece{\prefixOp{AnyVar}(\mixfixSep{}\variable{P}\mixfixSep{},
    \mixfixSep{}\variable{E}\mixfixSep{})}\mixfixSep{}end}}\mixfixSep{
  ...
  \mequation{}{\mixfixPiece{\variable{N}\mixfixSep{}()=> \mixfixSep{}\variable{
    T}}}{\mixfixPiece{\prefixOp{AnyVar}(\mixfixSep{}\variable{N}\mixfixSep{},
    \mixfixSep{}\mixfixPiece{{\mixfixSep{}\constant{[]}\mixfixSep{
    }}}\mixfixSep{},\mixfixSep{}\variable{T}\mixfixSep{})}}
